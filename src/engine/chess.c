	...
	for (int rank = 7; rank >= 0; rank--) {
		...
		for (int file = 0; file < 8; file++) {
			...
			if (board->white_pawns & bit)
				...
				piece = 'B';
			else if (board->white_queen & bit)
				piece = 'Q';
			else if (board->white_king & bit)
				piece = 'K';
			...
			// Check Black pieces (Lowercase)
				...
				piece = 'b';
			else if (board->black_queen & bit)
				piece = 'q';
			else if (board->black_king & bit)
				piece = 'k';
